...
@Component({
  ...
  styles: [ `
    ...
    .card {
      background: linear-gradient(to bottom,#3366668c 0%,#e06965 100%); 
    }
  `],
  template: `
  ...
  <form novalidate [formGroup]="form" (ngSubmit)="onSubmit()" *ngIf="responseApi.ok !== 1">
    ...
    <div class="row">
      ...
      label=" Description" required></form-message>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-10">
    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        <form-name [group]="form" [submitted]="submitted" name="first_name" label="Desgination" required></form-name>
      </div>
      <div class="col-sm-8">
        <form-name [group]="form" [submitted]="submitted" name="last_name" label="Department" required></form-name>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-10">
    ...
    <div class="row">
      ...
      <i class="icon-mail"></i> Submit </button>
      </div>
    </div>
    </form>
    `
